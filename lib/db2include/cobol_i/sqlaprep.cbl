      ...
      * Specifies whether or not the query is executed using asynchrony
       77  SQLA-FEDASYNC-OPT         PIC S9(4) COMP-5 VALUE 89.
      ...
      * Maximum sqlchar length for option[n].val when option[n].type is
      * SQLA_COLLECTION_OPT
       77  SQLA-MAX-COLLECTION       PIC S9(4) COMP-5 VALUE 128.
      ...
      * Maximum sqlchar length for option[n].val when option[n].type is
      * SQLA_OWNER_OPT
       77  SQLA-MAX-OWNER            PIC S9(4) COMP-5 VALUE 128.

      * Maximum sqlchar length for option[n].val when option[n].type is
      * SQLA_SCHEMA_OPT
       77  SQLA-MAX-SCHEMA           PIC S9(4) COMP-5 VALUE 128.

      * Maximum sqlchar length for option[n].val when option[n].type is
      * SQLA_QUALIFIER_OPT
       77  SQLA-MAX-QUALIFIER        PIC S9(4) COMP-5 VALUE 128.

      * Maximum sqlchar length for option[n].val when option[n].type is
      * SQLA_CATALOG_OPT
       77  SQLA-MAX-CATALOG          PIC S9(4) COMP-5 VALUE 128.
      ...
      * Maximum sqlchar length for option[n].val when option[n].type is
      * SQLA_GENERIC_OPT
       77  SQLA-MAX-GENERIC          PIC S9(4) COMP-5 VALUE 4096.
      ...
      * Maximum sqlchar length for option[n].val when option[n].type is
      * SQLA_FUNCTION_PATH
       77  SQLA-MAX-FUNCPATH         PIC S9(4) COMP-5 VALUE 2048.
      ...
      * No asynchrony is used
       77  SQLA-FEDASYNC-MIN         PIC S9(4) COMP-5 VALUE 0.
      * Allows the optimizer to determine the level of asynchrony.
       77  SQLA-FEDASYNC-ANY         PIC S9(4) COMP-5 VALUE -1.
      * Maximum value
       77  SQLA-FEDASYNC-MAX         PIC S9(9) COMP-5 VALUE 32767.
      ...
      * Request the outer precompiler to get the next function SQL statement
       77  SQLA-NEXT-FUNCTION-STMT   PIC S9(4) COMP-5 VALUE 25.
      ...
      * length of precompiler pid for V7.1 to V9
       77  SQL-PID-LENGTH-V71        PIC S9(4) COMP-5 VALUE 162.
      * length of precompiler pid
       77  SQL-PID-LENGTH            PIC S9(4) COMP-5 VALUE 292.
      * minimum length of precompiler pid
       77  SQL-MIN-PID-LENGTH        PIC S9(4) COMP-5 VALUE 164.
