      ...
      * V8.2.5.0
       77  SQL-REL8205               PIC S9(9) COMP-5 VALUE 8020500.
      * V8.2.6.0
       77  SQL-REL8206               PIC S9(9) COMP-5 VALUE 8020600.
      * V8.2.7.0
       77  SQL-REL8207               PIC S9(9) COMP-5 VALUE 8020700.
      * V9.0.0.0
       77  SQL-REL9000               PIC S9(9) COMP-5 VALUE 9000000.
      * V9.1.0.0
       77  SQL-REL9100               PIC S9(9) COMP-5 VALUE 9010000.
      * V9.1.1.0
       77  SQL-REL9101               PIC S9(9) COMP-5 VALUE 9010100.
      * V9.1.2.0
       77  SQL-REL9102               PIC S9(9) COMP-5 VALUE 9010200.
      * V9.1.3.0
       77  SQL-REL9103               PIC S9(9) COMP-5 VALUE 9010300.
      * V9.1.4.0
       77  SQL-REL9104               PIC S9(9) COMP-5 VALUE 9010400.
      * V9.5.2.0
       77  SQL-REL9502               PIC S9(9) COMP-5 VALUE 9050200.
      * V9.5.1.0
       77  SQL-REL9501               PIC S9(9) COMP-5 VALUE 9050100.
      * V9.5.0.0
       77  SQL-REL9500               PIC S9(9) COMP-5 VALUE 9050000.
      * Future Release
      ...
      * Maximum nbr of key parts in Index
       77  SQL-KEYPMAX               PIC S9(4) COMP-5 VALUE 64.
      * Maximum key length
       77  SQL-KEYLMAX               PIC S9(4) COMP-5 VALUE 8192.
      * Maximum key length for 4K page
       77  SQL-KEYLMAX-4KPAGE        PIC S9(4) COMP-5 VALUE 1024.
      * Maximum key length for 8K page
       77  SQL-KEYLMAX-8KPAGE        PIC S9(4) COMP-5 VALUE 2048.
      * Maximum key length for 16K page
       77  SQL-KEYLMAX-16KPAGE       PIC S9(4) COMP-5 VALUE 4096.
      * Maximum key length for 32K page
       77  SQL-KEYLMAX-32KPAGE       PIC S9(4) COMP-5 VALUE 8192.
      ...
      * Size of a DECFLOAT16 field
       77  SQL-DECFLOAT16-LENGTH     PIC S9(4) COMP-5 VALUE 8.
      * Size of a DECFLOAT34 field
       77  SQL-DECFLOAT34-LENGTH     PIC S9(4) COMP-5 VALUE 16.
      * Maximum precision for DECFLOAT
       77  SQL-MAXDECFLOAT           PIC S9(4) COMP-5 VALUE 34.
      ...
      * CCSID 9005 - Greece, Latin ISO 8859-7:2003 (with Euro)
       77  SQL-CP-9005               PIC S9(4) COMP-5 VALUE 9005.
      ...
      * Codepage 1374 - Big-5 extension of HKSCS, DBCS portion
       77  SQL-CP-1374               PIC S9(4) COMP-5 VALUE 1374.
      ...
      * Codepage 1252 + 1374 - Mixed Big-5 extension for HKSCS
       77  SQL-CP-1375               PIC S9(4) COMP-5 VALUE 1375.
      ...
      * Codepage1204 - UCS-2 (BOM)
       77  SQL-CP-1204               PIC S9(4) COMP-5 VALUE 1204.
      * Codepage1208 - UTF-8
      ...
      * Big-endian UTF-32
       77  SQL-CP-UTF32BE            PIC S9(4) COMP-5 VALUE 1232.
      * Little-endian UTF-32
       77  SQL-CP-UTF32LE            PIC S9(4) COMP-5 VALUE 1234.
      * Codepage1236 - UTF-32 (BOM)
       77  SQL-CP-1236               PIC S9(4) COMP-5 VALUE 1236.
      ...
      * UTF-8
       77  SQL-CP-UTF8               PIC S9(4) COMP-5 VALUE 1208.
      * Big-endian UTF-16
      ...
      * Hong Kong Big5 HKSCS
       77  SQL-HKBIG5-PC             PIC S9(4) COMP-5 VALUE 16.
      * Unknown
      ...
      * error is tolerated
       77  SQL-WARN-ETO              PIC S9(4) COMP-5 VALUE 5.
      ...
      * Explicit Trusted Connection warning
       77  SQL-ETC-WARNING           PIC X(1) value "Y"
                                     USAGE DISPLAY NATIVE.
      * SQLDA Constants
      ...
      * Variable Binary
       77  SQL-TYP-VARBINARY         PIC S9(4) COMP-5 VALUE 908.
       77  SQL-TYP-NVARBINARY        PIC S9(4) COMP-5 VALUE 909.

      * Fixed Binary
       77  SQL-TYP-BINARY            PIC S9(4) COMP-5 VALUE 912.
       77  SQL-TYP-NBINARY           PIC S9(4) COMP-5 VALUE 913.
      ...
      * XML
       77  SQL-TYP-XML               PIC S9(4) COMP-5 VALUE 988.
       77  SQL-TYP-NXML              PIC S9(4) COMP-5 VALUE 989.

      * Decimal Float (16/34)
       77  SQL-TYP-DECFLOAT          PIC S9(4) COMP-5 VALUE 996.
       77  SQL-TYP-NDECFLOAT         PIC S9(4) COMP-5 VALUE 997.
      ...
      * Length of an sqlfile LOB file host var
       77  SQL-SQLFILE-LEN           PIC S9(4) COMP-5 VALUE 267.
      ...
      * Specifies whether or not the query is executed using asynchrony
       77  SQL-FEDASYNC-OPT          PIC S9(4) COMP-5 VALUE 89.
      ...
      * BINDFILE and VALIDATE RUN options will be implicitely specified.
       77  SQL-NODB-OPT              PIC S9(4) COMP-5 VALUE 90.
      * Option for granting privileges to a role - bind option only
       77  SQL-GRANT-ROLE-OPT        PIC S9(4) COMP-5 VALUE 91.

      * # of PREP/BIND/REBIND options
       77  SQL-NUM-OPTS              PIC S9(4) COMP-5 VALUE 91.
      ...
      * SQL_GENERIC_OPT
       77  SQL-MAX-GENERIC           PIC S9(4) COMP-5 VALUE 4096.
      ...
      * Maximum sqlchar length for option[n].val when option[n].type is
      * SQL_COLLECTION_OPT
       77  SQL-MAX-COLLECTION        PIC S9(4) COMP-5 VALUE 128.
      ...
      * Maximum sqlchar length for option[n].val when option[n].type is
      * SQL_OWNER_OPT
       77  SQL-MAX-OWNER             PIC S9(4) COMP-5 VALUE 128.

      * Maximum sqlchar length for option[n].val when option[n].type is
      * SQL_SCHEMA_OPT
       77  SQL-MAX-SCHEMA            PIC S9(4) COMP-5 VALUE 128.

      * Maximum sqlchar length for option[n].val when option[n].type is
      * SQL_QUALIFIER_OPT
       77  SQL-MAX-QUALIFIER         PIC S9(4) COMP-5 VALUE 128.

      * Maximum sqlchar length for option[n].val when option[n].type is
      * SQL_CATALOG_OPT
       77  SQL-MAX-CATALOG           PIC S9(4) COMP-5 VALUE 128.
      ...
      * Maximum sqlchar length for option[n].val when option[n].type is
      * SQL_FUNCTION_PATH
       77  SQL-MAX-FUNCPATH          PIC S9(4) COMP-5 VALUE 2048.
      ...
      * Use a database to precompiler.
       77  SQL-USEDB                 PIC S9(4) COMP-5 VALUE 0.
      * Do not use a database to precompile.
       77  SQL-NODB                  PIC S9(4) COMP-5 VALUE 1.

      * Values used for option[n].val when option[n].type is
      * SQL_FEDASYNC_OPT
      * No asynchrony is used
       77  SQL-FEDASYNC-MIN          PIC S9(4) COMP-5 VALUE 0.
      * Allows the optimizer to determine the level of asynchrony
       77  SQL-FEDASYNC-ANY          PIC S9(4) COMP-5 VALUE -1.
      * Maximum value
       77  SQL-FEDASYNC-MAX          PIC S9(9) COMP-5 VALUE 32767.
      ...
      * SYSADM Authority
       77  SQL-DBAUTH-SYSADM         PIC S9(4) COMP-5 VALUE 0.
      * DBADM Authority
       77  SQL-DBAUTH-DBADM          PIC S9(4) COMP-5 VALUE 1.
      * CREATETAB Privilege
       77  SQL-DBAUTH-CREATETAB      PIC S9(4) COMP-5 VALUE 2.
      * BINDADD Privilege
       77  SQL-DBAUTH-BINDADD        PIC S9(4) COMP-5 VALUE 3.
      * CONNECT Privilege
       77  SQL-DBAUTH-CONNECT        PIC S9(4) COMP-5 VALUE 4.
      * CREATE_NOT_FENCED Privilege
       77  SQL-DBAUTH-CREATE-NOT-FENC PIC S9(4) COMP-5 VALUE 5.
      * SYSCTRL Authority
       77  SQL-DBAUTH-SYSCTRL        PIC S9(4) COMP-5 VALUE 6.
      * SYSMAINT Authority
       77  SQL-DBAUTH-SYSMAINT       PIC S9(4) COMP-5 VALUE 7.
      * IMPLICIT_SCHEMA Privilege
       77  SQL-DBAUTH-IMPLICIT-SCHEMA PIC S9(4) COMP-5 VALUE 8.
      * LOAD Privilege
       77  SQL-DBAUTH-LOAD           PIC S9(4) COMP-5 VALUE 9.
      * CREATE_EXTERNAL_ROUTINE Privilege
       77  SQL-DBAUTH-CREATE-EXT-RT  PIC S9(4) COMP-5 VALUE 10.
      * LIBRARYADM Privilege
       77  SQL-DBAUTH-LIBADM         PIC S9(4) COMP-5 VALUE 11.
      * QUIESCE_CONNECT Privilege
       77  SQL-DBAUTH-QUIESCE-CONN   PIC S9(4) COMP-5 VALUE 12.
      * SECURITYADM Privilege
       77  SQL-DBAUTH-SECADM         PIC S9(4) COMP-5 VALUE 13.
      * SYSQUIESCE Authority
       77  SQL-DBAUTH-SYSQUIESCE     PIC S9(4) COMP-5 VALUE 14.
      * SYSMON Authority
       77  SQL-DBAUTH-SYSMON         PIC S9(4) COMP-5 VALUE 15.
      * Max Number of Authorities
       77  SQL-DBAUTH-MAX            PIC S9(4) COMP-5 VALUE 16.

      * Authority origin 
      * USER direct
       77  SQL-AUTH-ORIGIN-USER      PIC S9(4) COMP-5 VALUE 1.
      * GROUP indirect
       77  SQL-AUTH-ORIGIN-GROUP     PIC S9(4) COMP-5 VALUE 2.
      * ROLE indirect
       77  SQL-AUTH-ORIGIN-ROLE      PIC S9(4) COMP-5 VALUE 4.
      * PUBLIC indirect
       77  SQL-AUTH-ORIGIN-PUBLIC    PIC S9(4) COMP-5 VALUE 8.
      ...
      * Value of SQL-SYSQUIESCE-GRP is 1073741824
      ...
      * Value of SQL-SYSMON-GRP is 2147483648
      ...
      * Read Privilege
       77  SQL-VAR-REA               PIC S9(4) COMP-5 VALUE 1.
      * Write Privilege
       77  SQL-VAR-WRI               PIC S9(4) COMP-5 VALUE 2.
      ...
      * Read Privilege Grantable
       77  SQL-VAR-REA-G             PIC S9(4) COMP-5 VALUE 256.
      * Write Privilege Grantable
       77  SQL-VAR-WRI-G             PIC S9(4) COMP-5 VALUE 512.
