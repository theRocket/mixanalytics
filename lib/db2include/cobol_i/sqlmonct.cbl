      ...
      *****************************************************************************
       ...
       77 SQLM-DBMON-VERSION9
           PIC S9(4) COMP-5 VALUE 8.

       77 SQLM-DBMON-VERSION9-5
      ...
      * Database Manager snapshot *
       77 SQLMA-DB2
           PIC S9(5) COMP-5 VALUE 65537.


      * List of connections *
       77 SQLMA-DBASE-APPLINFO
           PIC S9(5) COMP-5 VALUE 65543.

       77 SQLMA-APPLINFO-ALL
           PIC S9(5) COMP-5 VALUE 65547.

       77 SQLMA-DCS-APPLINFO-ALL
           PIC S9(5) COMP-5 VALUE 65548.


      * Database snapshot *
       77 SQLMA-DBASE
           PIC S9(5) COMP-5 VALUE 65538.

       77 SQLMA-DBASE-ALL
           PIC S9(5) COMP-5 VALUE 65545.

       77 SQLMA-DCS-DBASE
           PIC S9(5) COMP-5 VALUE 65570.

       77 SQLMA-DCS-DBASE-ALL
           PIC S9(5) COMP-5 VALUE 65571.

       77 SQLMA-DBASE-REMOTE
           PIC S9(5) COMP-5 VALUE 65573.

       77 SQLMA-DBASE-REMOTE-ALL
           PIC S9(5) COMP-5 VALUE 65574.


      * Application snapshot *
       77 SQLMA-APPL-ALL
           PIC S9(5) COMP-5 VALUE 65546.

       77 SQLMA-APPL
           PIC S9(5) COMP-5 VALUE 65539.

       77 SQLMA-AGENT-ID
           PIC S9(5) COMP-5 VALUE 65540.

       77 SQLMA-DBASE-APPLS
           PIC S9(5) COMP-5 VALUE 65542.

       77 SQLMA-DCS-APPL-ALL
           PIC S9(5) COMP-5 VALUE 65566.

       77 SQLMA-DCS-APPL
           PIC S9(5) COMP-5 VALUE 65567.

       77 SQLMA-DCS-APPL-HANDLE
           PIC S9(5) COMP-5 VALUE 65568.

       77 SQLMA-DCS-DBASE-APPLS
           PIC S9(5) COMP-5 VALUE 65569.

       77 SQLMA-DBASE-APPLS-REMOTE
           PIC S9(5) COMP-5 VALUE 65575.

       77 SQLMA-APPL-REMOTE-ALL
           PIC S9(5) COMP-5 VALUE 65576.


      * Table snapshot *
       77 SQLMA-DBASE-TABLES
           PIC S9(5) COMP-5 VALUE 65541.


      * Tablespace snapshot *
       77 SQLMA-DBASE-TABLESPACES
           PIC S9(5) COMP-5 VALUE 65549.


      * Snapshot for locks *
       77 SQLMA-APPL-LOCKS
           PIC S9(5) COMP-5 VALUE 65556.

       77 SQLMA-APPL-LOCKS-AGENT-ID
           PIC S9(5) COMP-5 VALUE 65557.

       77 SQLMA-DBASE-LOCKS
           PIC S9(5) COMP-5 VALUE 65544.


      * Bufferpool snapshot *
       77 SQLMA-DBASE-BUFFERPOOLS
           PIC S9(5) COMP-5 VALUE 65558.

       77 SQLMA-BUFFERPOOLS-ALL
           PIC S9(5) COMP-5 VALUE 65559.


      * Dynamic sql snapshot *
       77 SQLMA-DYNAMIC-SQL
           PIC S9(5) COMP-5 VALUE 65572.
      ...
      *****************************************************************************
       ...
       77 SQLM-APPLID-SZ
           PIC S9(4) COMP-5 VALUE 64.

       77 SQLM-APPLID-SZ-V8
      ...
      *****************************************************************************
       ...
       77 SQLM-TABLESPACE-CONTENT-LARGE
           PIC S9(4) COMP-5 VALUE 1.
      ...
      * Memory Pool List ID's (for element SQLM_ELM_POOL_LIST_ID)                  *
       77 SQLM-POOL-LIST-ID-APPLSHR
           PIC S9(4) COMP-5 VALUE 0.

       77 SQLM-POOL-LIST-ID-PRIVAGENT
           PIC S9(4) COMP-5 VALUE 1.
      ...
      *****************************************************************************
       ...
       77 SQLM-LOCKRELFLAGS-SQLCOMPILER
           PIC S9(18) COMP-5 VALUE -2147483648.

       77 SQLM-LOCKRELFLAGS-UNTRACKED
           PIC S9(5) COMP-5 VALUE 1073741824.
      ...
      *****************************************************************************
       ...
       77 SQLM-TABLE-PART-LOCK
           PIC S9(4) COMP-5 VALUE 20.

       77 SQLM-AUTORESIZE-LOCK
           PIC S9(4) COMP-5 VALUE 21.

       77 SQLM-AUTOSTORAGE-LOCK
           PIC S9(4) COMP-5 VALUE 22.

       77 SQLM-XML-PATH-LOCK
           PIC S9(4) COMP-5 VALUE 23.
      ...
      *****************************************************************************
       ...
       77 SQLM-PLATFORM-SUNX86
           PIC S9(4) COMP-5 VALUE 33.

       77 SQLM-PLATFORM-SUNX8664
      ...
      *****************************************************************************
       77 SQLM-RC-INV-PTR
           PIC S9(5) COMP-5 VALUE -1601.

       77 SQLM-RC-INV-OBJ-TYPE
           PIC S9(5) COMP-5 VALUE -1602.

       77 SQLM-RC-NOT-SPECIFIED
           PIC S9(5) COMP-5 VALUE -1603.

       77 SQLM-RC-NOT-NULL-TERM
           PIC S9(5) COMP-5 VALUE -1604.
       ...
       77 SQLM-RC-NOMEM
           PIC S9(5) COMP-5 VALUE -1607.

       77 SQLM-RC-DUPLICATE-DB
           PIC S9(4) COMP-5 VALUE 1608.

       77 SQLM-RC-REMOTE-DB
           PIC S9(5) COMP-5 VALUE -1609.

       77 SQLM-RC-INV-VALUE
           PIC S9(5) COMP-5 VALUE -1610.

       77 SQLM-RC-NO-DATA
           PIC S9(4) COMP-5 VALUE 1611.

       77 SQLM-RC-TOO-MANY-OBJECTS
           PIC S9(5) COMP-5 VALUE -1623.

       77 SQLM-RC-MULTIPLE-NODES
           PIC S9(5) COMP-5 VALUE -1624.

       77 SQLM-RC-MEMORY-ERROR
           PIC S9(5) COMP-5 VALUE -83.
      ...
      *****************************************************************************
       77 SQLM-UTILITY-STATE-EXECUTE
           PIC S9(4) COMP-5 VALUE 0.

       77 SQLM-UTILITY-STATE-WAIT
           PIC S9(4) COMP-5 VALUE 1.

       77 SQLM-UTILITY-STATE-ERROR
           PIC S9(4) COMP-5 VALUE 2.
      ...
      *****************************************************************************
       77 SQLM-UTILITY-INVOKER-USER
           PIC S9(4) COMP-5 VALUE 0.

       77 SQLM-UTILITY-INVOKER-AUTO
           PIC S9(4) COMP-5 VALUE 1.
      ...
      *****************************************************************************
       ...
       77 SQLM-HADR-STATE-DISCONN-PEER
           PIC S9(4) COMP-5 VALUE 5.
      ...
      * The full name of the monitor element is SQLM_ELM_TABLESPACE_RANGE_CONTAINER
       ...
       77 SQLM-ELM-DB-STO-PATH-INFO
           PIC S9(4) COMP-5 VALUE 58.


       77 SQLM-ELM-MEMORY-POOL-LIST
           PIC S9(4) COMP-5 VALUE 59.
      ...
      *****************************************************************************
       ...
       77 SQLM-ELM-EVENT-ACTIVITY
           PIC S9(4) COMP-5 VALUE 122.

       77 SQLM-ELM-EVENT-ACTIVITYSTMT
           PIC S9(4) COMP-5 VALUE 123.

       77 SQLM-ELM-EVENT-ACTIVITYVALS
           PIC S9(4) COMP-5 VALUE 124.

       77 SQLM-ELM-EVENT-SCSTATS
           PIC S9(4) COMP-5 VALUE 125.

       77 SQLM-ELM-EVENT-WCSTATS
           PIC S9(4) COMP-5 VALUE 126.

       77 SQLM-ELM-EVENT-WLSTATS
           PIC S9(4) COMP-5 VALUE 127.

       77 SQLM-ELM-EVENT-QSTATS
           PIC S9(4) COMP-5 VALUE 128.

       77 SQLM-ELM-EVENT-HISTOGRAMBIN
           PIC S9(4) COMP-5 VALUE 129.

      * The full name of the monitor element is SQLM_ELM_EVENT_THRESHOLD_VIOLATIONS
       77 SQLM-ELM-EVENT-THRE-VIOLATIONS
           PIC S9(4) COMP-5 VALUE 130.
      ...
      * The full name of the monitor element is SQLM_ELM_HASH_JOIN_SMALL_OVERFLOWS
       ...
       77 SQLM-ELM-ROWS-FETCHED
           PIC S9(4) COMP-5 VALUE 522.

       77 SQLM-ELM-ROWS-WRITTEN
           PIC S9(4) COMP-5 VALUE 523.

       77 SQLM-ELM-ROWS-MODIFIED
           PIC S9(4) COMP-5 VALUE 523.
       ...
       77 SQLM-ELM-COORD-PARTITION-NUM
           PIC S9(4) COMP-5 VALUE 526.
      ...
      *  New elements for v9.1                                                     *
       77 SQLM-ELM-REORG-LONG-TBSPC-ID
           PIC S9(4) COMP-5 VALUE 862.


       77 SQLM-ELM-DATA-PARTITION-ID
           PIC S9(4) COMP-5 VALUE 863.

       77 SQLM-ELM-PROGRESS-LIST-ATTR
           PIC S9(4) COMP-5 VALUE 864.


      *****************************************************************************
      * New REORG monitoring elements for v9 (Row Compression)                     *
      *****************************************************************************
       77 SQLM-ELM-REORG-ROWSCOMPRESSED
           PIC S9(4) COMP-5 VALUE 865.

       77 SQLM-ELM-REORG-ROWSREJECTED
           PIC S9(4) COMP-5 VALUE 866.
      ...
      *****************************************************************************
       77 SQLM-ELM-CH-FREE
           PIC S9(4) COMP-5 VALUE 867.

       77 SQLM-ELM-CH-FREE-BOTTOM
           PIC S9(4) COMP-5 VALUE 868.

      *****************************************************************************
      * Utility monitoring element additions for v9                                *
      *****************************************************************************
       77 SQLM-ELM-UTILITY-STATE
           PIC S9(4) COMP-5 VALUE 869.

       77 SQLM-ELM-UTILITY-INVOKER-TYPE
           PIC S9(4) COMP-5 VALUE 870.
      ...
      * The full name of the monitor element is SQLM_ELM_POST_SHRTHRESHOLD_SORTS
       77 SQLM-ELM-POST-SHRTHRESH-SORTS
           PIC S9(4) COMP-5 VALUE 871.

      * The full name of the monitor element is SQLM_ELM_POST_SHRTHRESHOLD_HASH_JOINS
       77 SQLM-ELM-POST-SHRTHRESH-HASHJ
           PIC S9(4) COMP-5 VALUE 872.

       77 SQLM-ELM-ACTIVE-HASH-JOINS
           PIC S9(4) COMP-5 VALUE 873.


       77 SQLM-ELM-POOL-SECONDARY-ID
           PIC S9(4) COMP-5 VALUE 874.


       77 SQLM-ELM-FS-ID
           PIC S9(4) COMP-5 VALUE 875.

       77 SQLM-ELM-FS-TOTAL-SZ
           PIC S9(4) COMP-5 VALUE 876.

       77 SQLM-ELM-FS-USED-SZ
           PIC S9(4) COMP-5 VALUE 877.

       77 SQLM-ELM-STO-PATH-FREE-SZ
           PIC S9(4) COMP-5 VALUE 878.


       77 SQLM-ELM-POOL-XDA-L-READS
           PIC S9(4) COMP-5 VALUE 879.

       77 SQLM-ELM-POOL-XDA-P-READS
           PIC S9(4) COMP-5 VALUE 880.

       77 SQLM-ELM-POOL-XDA-WRITES
           PIC S9(4) COMP-5 VALUE 881.

       77 SQLM-ELM-POOL-TEMP-XDA-L-READS
           PIC S9(4) COMP-5 VALUE 882.

       77 SQLM-ELM-POOL-TEMP-XDA-P-READS
           PIC S9(4) COMP-5 VALUE 883.

       77 SQLM-ELM-POOL-ASYNC-XDA-READS
           PIC S9(4) COMP-5 VALUE 884.

       77 SQLM-ELM-POOL-ASYNC-XDA-WRITES
           PIC S9(4) COMP-5 VALUE 885.

      * The full name of the monitor element is SQLM_ELM_POOL_ASYNC_XDA_READ_REQS
       77 SQLM-ELM-PL-ASYNC-XDA-RD-REQS
           PIC S9(4) COMP-5 VALUE 886.

       77 SQLM-ELM-XDA-OBJECT-PAGES
           PIC S9(4) COMP-5 VALUE 887.

       77 SQLM-ELM-XQUERY-STMTS
           PIC S9(4) COMP-5 VALUE 888.


      *****************************************************************************
      * New Trusted Context monitor element for v9                                 *
      *****************************************************************************
       77 SQLM-ELM-TRUSTED-AUTH-ID
           PIC S9(4) COMP-5 VALUE 889.


      ****************************************************************************
      * HADR Peer Window elements                                                 *
      ****************************************************************************
       77 SQLM-ELM-HADR-PEER-WINDOW-END
           PIC S9(4) COMP-5 VALUE 890.

       77 SQLM-ELM-HADR-PEER-WINDOW
           PIC S9(4) COMP-5 VALUE 891.
      ...
      * The full name of the monitor element is SQLM_ELM_BLOCKS_PENDING_CLEANUP
       77 SQLM-ELM-BLOCKS-PEND-CLEANUP
           PIC S9(4) COMP-5 VALUE 892.

       77 SQLM-ELM-AUTHORITY-BITMAP
           PIC S9(4) COMP-5 VALUE 893.


       77 SQLM-ELM-TOTAL-OLAP-FUNCS
           PIC S9(4) COMP-5 VALUE 894.

      * The full name of the monitor element is SQLM_ELM_POST_THRESHOLD_OLAP_FUNCS
       77 SQLM-ELM-POST-THRE-OLAP-FUNCS
           PIC S9(4) COMP-5 VALUE 895.

      * after sortheap threshold    *
      * exceeded                    *
       77 SQLM-ELM-ACTIVE-OLAP-FUNCS
           PIC S9(4) COMP-5 VALUE 896.

      * running                     *
       77 SQLM-ELM-OLAP-FUNC-OVERFLOWS
           PIC S9(4) COMP-5 VALUE 897.
      ...
      *****************************************************************************
       ...
       77 SQLM-ELM-SERVICE-CLASS-ID
           PIC S9(4) COMP-5 VALUE 898.

      * The full name of the monitor element is SQLM_ELM_SERVICE_SUPERCLASS_NAME
       77 SQLM-ELM-SERVICE-SPRCLASS-NAME
           PIC S9(4) COMP-5 VALUE 899.

       77 SQLM-ELM-SERVICE-SUBCLASS-NAME
           PIC S9(4) COMP-5 VALUE 900.

       77 SQLM-ELM-WORK-ACTION-SET-ID
           PIC S9(4) COMP-5 VALUE 901.

       77 SQLM-ELM-WORK-ACTION-SET-NAME
           PIC S9(4) COMP-5 VALUE 902.

       77 SQLM-ELM-DB-WORK-ACTION-SET-ID
           PIC S9(4) COMP-5 VALUE 903.

       77 SQLM-ELM-SC-WORK-ACTION-SET-ID
           PIC S9(4) COMP-5 VALUE 904.

       77 SQLM-ELM-WORK-CLASS-ID
           PIC S9(4) COMP-5 VALUE 905.

       77 SQLM-ELM-WORK-CLASS-NAME
           PIC S9(4) COMP-5 VALUE 906.

       77 SQLM-ELM-DB-WORK-CLASS-ID
           PIC S9(4) COMP-5 VALUE 907.

       77 SQLM-ELM-SC-WORK-CLASS-ID
           PIC S9(4) COMP-5 VALUE 908.

       77 SQLM-ELM-WORKLOAD-ID
           PIC S9(4) COMP-5 VALUE 909.

      * The full name of the monitor element is SQLM_ELM_WORKLOAD_OCCURRENCE_ID
       77 SQLM-ELM-WL-OCCURRENCE-ID
           PIC S9(4) COMP-5 VALUE 910.

       77 SQLM-ELM-WORKLOAD-NAME
           PIC S9(4) COMP-5 VALUE 911.

       77 SQLM-ELM-TEMP-TABLESPACE-TOP
           PIC S9(4) COMP-5 VALUE 912.

       77 SQLM-ELM-ROWS-RETURNED-TOP
           PIC S9(4) COMP-5 VALUE 913.

       77 SQLM-ELM-CONCURRENT-ACT-TOP
           PIC S9(4) COMP-5 VALUE 914.

      * The full name of the monitor element is SQLM_ELM_CONCURRENT_CONNECTION_TOP
       77 SQLM-ELM-CONCURR-CONN-TOP
           PIC S9(4) COMP-5 VALUE 915.

       77 SQLM-ELM-COST-ESTIMATE-TOP
           PIC S9(4) COMP-5 VALUE 916.

       77 SQLM-ELM-STATISTICS-TIMESTAMP
           PIC S9(4) COMP-5 VALUE 917.

       77 SQLM-ELM-ACT-TOTAL
           PIC S9(4) COMP-5 VALUE 918.

       77 SQLM-ELM-WLO-COMPLETED-TOTAL
           PIC S9(4) COMP-5 VALUE 919.

       77 SQLM-ELM-CONCURRENT-WLO-TOP
           PIC S9(4) COMP-5 VALUE 920.

      * The full name of the monitor element is SQLM_ELM_CONCURRENT_WLO_ACT_TOP
       77 SQLM-ELM-WORKLD-CONC-WLOACTTOP
           PIC S9(4) COMP-5 VALUE 921.

       77 SQLM-ELM-TOP
           PIC S9(4) COMP-5 VALUE 922.

       77 SQLM-ELM-BOTTOM
           PIC S9(4) COMP-5 VALUE 923.

       77 SQLM-ELM-HISTOGRAM-TYPE
           PIC S9(4) COMP-5 VALUE 924.

       77 SQLM-ELM-BIN-ID
           PIC S9(4) COMP-5 VALUE 925.


       77 SQLM-ELM-ACTIVITY-ID
           PIC S9(4) COMP-5 VALUE 926.

       77 SQLM-ELM-ACTIVITY-SECONDARY-ID
           PIC S9(4) COMP-5 VALUE 927.

       77 SQLM-ELM-UOW-ID
           PIC S9(4) COMP-5 VALUE 928.

       77 SQLM-ELM-PARENT-ACTIVITY-ID
           PIC S9(4) COMP-5 VALUE 929.

       77 SQLM-ELM-PARENT-UOW-ID
           PIC S9(4) COMP-5 VALUE 930.

       77 SQLM-ELM-TIME-OF-VIOLATION
           PIC S9(4) COMP-5 VALUE 931.

       77 SQLM-ELM-ACTIVITY-COLLECTED
           PIC S9(4) COMP-5 VALUE 932.

       77 SQLM-ELM-ACTIVITY-TYPE
           PIC S9(4) COMP-5 VALUE 933.

       77 SQLM-ELM-THRESHOLD-PREDICATE
           PIC S9(4) COMP-5 VALUE 934.

       77 SQLM-ELM-THRESHOLD-ACTION
           PIC S9(4) COMP-5 VALUE 935.

       77 SQLM-ELM-THRESHOLD-MAXVALUE
           PIC S9(4) COMP-5 VALUE 936.

       77 SQLM-ELM-THRESHOLD-QUEUESIZE
           PIC S9(4) COMP-5 VALUE 937.

      * The full name of the monitor element is SQLM_ELM_COORD_ACT_COMPLETED_TOTAL
       77 SQLM-ELM-COORD-ACT-COMP-TOT
           PIC S9(4) COMP-5 VALUE 938.

      * The full name of the monitor element is SQLM_ELM_COORD_ACT_ABORTED_TOTAL
       77 SQLM-ELM-COORD-ACT-ABOR-TOT
           PIC S9(4) COMP-5 VALUE 939.

      * The full name of the monitor element is SQLM_ELM_COORD_ACT_REJECTED_TOTAL
       77 SQLM-ELM-COORD-ACT-REJ-TOT
           PIC S9(4) COMP-5 VALUE 940.

      * The full name of the monitor element is SQLM_ELM_COORD_ACT_LIFETIME_TOP
       77 SQLM-ELM-COORD-LIFETIME-TOP
           PIC S9(4) COMP-5 VALUE 941.

       77 SQLM-ELM-ACT-EXEC-TIME
           PIC S9(4) COMP-5 VALUE 942.

       77 SQLM-ELM-TIME-CREATED
           PIC S9(4) COMP-5 VALUE 943.

       77 SQLM-ELM-TIME-STARTED
           PIC S9(4) COMP-5 VALUE 944.

       77 SQLM-ELM-TIME-COMPLETED
           PIC S9(4) COMP-5 VALUE 945.

       77 SQLM-ELM-SECTION-ENV
           PIC S9(4) COMP-5 VALUE 946.

       77 SQLM-ELM-ACTIVATE-TIMESTAMP
           PIC S9(4) COMP-5 VALUE 947.

      * The full name of the monitor element is SQLM_ELM_NUM_THRESHOLD_VIOLATIONS
       77 SQLM-ELM-NUM-THRESHOLD-VIOLAT
           PIC S9(4) COMP-5 VALUE 948.

       77 SQLM-ELM-ARM-CORRELATOR
           PIC S9(4) COMP-5 VALUE 949.

       77 SQLM-ELM-PREP-TIME
           PIC S9(4) COMP-5 VALUE 950.

       77 SQLM-ELM-QUEUE-SIZE-TOP
           PIC S9(4) COMP-5 VALUE 951.

      * The full name of the monitor element is SQLM_ELM_QUEUE_ASSIGNMENTS_TOTAL
       77 SQLM-ELM-QUEUE-ASSIGNMENTS-TOT
           PIC S9(4) COMP-5 VALUE 953.

       77 SQLM-ELM-QUEUE-TIME-TOTAL
           PIC S9(4) COMP-5 VALUE 954.

       77 SQLM-ELM-LAST-WLM-RESET
           PIC S9(4) COMP-5 VALUE 955.

       77 SQLM-ELM-THRESHOLD-DOMAIN
           PIC S9(4) COMP-5 VALUE 956.

       77 SQLM-ELM-THRESHOLD-NAME
           PIC S9(4) COMP-5 VALUE 957.

       77 SQLM-ELM-THRESHOLDID
           PIC S9(4) COMP-5 VALUE 958.

       77 SQLM-ELM-NUMBER-IN-BIN
           PIC S9(4) COMP-5 VALUE 959.

      * The full name of the monitor element is SQLM_ELM_COORD_ACT_LIFETIME_AVG
       77 SQLM-ELM-COORD-ACT-LIFETIM-AVG
           PIC S9(4) COMP-5 VALUE 960.

      * The full name of the monitor element is SQLM_ELM_COORD_ACT_QUEUE_TIME_AVG
       77 SQLM-ELM-COORD-ACT-Q-TIME-AVG
           PIC S9(4) COMP-5 VALUE 961.

      * The full name of the monitor element is SQLM_ELM_COORD_ACT_EXEC_TIME_AVG
       77 SQLM-ELM-COORD-ACT-EXECTIM-AVG
           PIC S9(4) COMP-5 VALUE 962.

      * The full name of the monitor element is SQLM_ELM_COORD_ACT_EST_COST_AVG
       77 SQLM-ELM-COORD-ACT-ESTCOST-AVG
           PIC S9(4) COMP-5 VALUE 963.

      * The full name of the monitor element is SQLM_ELM_COORD_ACT_INTERARRIVAL_TIME_AVG
       77 SQLM-ELM-COORD-ACT-IA-TIME-AVG
           PIC S9(4) COMP-5 VALUE 964.

       77 SQLM-ELM-REQUEST-EXEC-TIME-AVG
           PIC S9(4) COMP-5 VALUE 965.


      *****************************************************************************
      * New elements for JITS                                                      *
      *****************************************************************************
       77 SQLM-ELM-STATS-CACHE-SIZE
           PIC S9(4) COMP-5 VALUE 966.

       77 SQLM-ELM-STATS-FABRICATIONS
           PIC S9(4) COMP-5 VALUE 967.

       77 SQLM-ELM-STATS-FABRICATE-TIME
           PIC S9(4) COMP-5 VALUE 968.

       77 SQLM-ELM-SYNC-RUNSTATS
           PIC S9(4) COMP-5 VALUE 969.

       77 SQLM-ELM-SYNC-RUNSTATS-TIME
           PIC S9(4) COMP-5 VALUE 970.

       77 SQLM-ELM-ASYNC-RUNSTATS
           PIC S9(4) COMP-5 VALUE 971.


      * Memory Pool List element                                                   *
       77 SQLM-ELM-POOL-LIST-ID
           PIC S9(4) COMP-5 VALUE 972.


       77 SQLM-ELM-IS-SYSTEM-APPL
           PIC S9(4) COMP-5 VALUE 973.
      ...
      * The full name of the monitor element is SQLM_HI_VAL_TSCONT_INACCESSIBLE
       77 SQLM-HI-VAL-TSCONT-INACCESSIB
           PIC S9(4) COMP-5 VALUE 0.

       77 SQLM-HI-VAL-TSCONT-ACCESSIBLE
           PIC S9(4) COMP-5 VALUE 1.
      ...
      *****************************************************************************
       ...
       77 SQLM-INSTREAM-ELM-DBNAME
           PIC S9(4) COMP-5 VALUE 128.

       77 SQLM-INSTREAM-ELM-APPLID
           PIC S9(4) COMP-5 VALUE 129.

       77 SQLM-INSTREAM-ELM-AGENTID
           PIC S9(4) COMP-5 VALUE 130.
      ...
      *****************************************************************************
       77 SQLM-INSTREAM-ADD-REQUEST
           PIC S9(4) COMP-5 VALUE 1.

       77 SQLM-INSTREAM-ADD-QUALIFIER
           PIC S9(4) COMP-5 VALUE 2.

       77 SQLM-INSTREAM-ADD-REQQUAL
           PIC S9(4) COMP-5 VALUE 3.
      ...
      ******************************************************************
       ...
       01 SQLMA.
          ...
          05 OBJ-VAR OCCURS 0 TO 100 TIMES DEPENDING ON OBJ-NUM.
             ...
             10 SQLMA-OBJECT         PIC X(128) USAGE DISPLAY NATIVE.
