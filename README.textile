...
h2.  SET UP A BACKEND DATA SOURCE
    ...
    * If you are using another backend you will need to create a Source Adapter class or create “prolog”, “call”,
...
h3. Backend Code Columns

	* SOURCE ADAPTER - this is the name of a class used for query, create, update and delete operations.  The Ruby file for this class needs to be placed in the LIB subdirectory of RhoSync. OR you can enter all of the code for ech of the methods in the fields below
