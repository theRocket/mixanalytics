...
h2. INSTALLATION & ADMINISTRATION
...
h3. Backend Code Columns
	...
	* SOURCE ADAPTER - this is the name of a class used for query, create, update and delete operations.  The Ruby file for this class needs to be placed in the LIB subdirectory of RhoSync
